<?php
/**
 * Custom widget for latest blog posts
 * @author webinpixels
 * 2012
 */
class Wip_Blog_Widget extends WP_Widget {
	function Wip_Blog_Widget() {
		$widget_ops = array('classname' => 'widget_latest_blog', 'description' => __('Latest Blog Posts', 'wip') );
		$control_ops = array( 'width' => 400, 'height' => 200);
		$this->WP_Widget('latest_blog', 'The Builder - Latest Blog', $widget_ops, $control_ops);
	}
	...
	function widget($args, $instance) {
		...
		echo $before_widget;
		$title = empty($instance['title']) ? 'Latest Blog' : apply_filters('widget_title', $instance['title']);
		...
		echo wipfr_latest_blog( $entry_numb, $use_thumbnail, $use_excerpt, $e_length );
...
register_widget('Wip_Blog_Widget');