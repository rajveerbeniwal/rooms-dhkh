...
class Securimage {
   ...
   *
   * @public string  The path to the word list to use for creating CAPTCHA codes
   */
   ...
   * @public mixed
   */
  public $gd_font_file = 'gdfonts/bubblebath.gdf';
   ...
   * @public string
   */
  public $multi_text_color = "#0a68dd,#f65c47,#8d32fd";
